...
/**
 * Servlet implementation class getEUIAndEPUIChartDaily EUI&EPUI日圖表
 */
@WebServlet("/getEUIAndEPUIChartDaily")
public class getEUIAndEPUIChartDaily extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getFormatterLogger(getEUIAndEPUIChartDaily.class.getName());

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public getEUIAndEPUIChartDaily() {
		super();
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logger.debug("getEUIAndEPUIChartDaily start");
		...
		logger.debug("getEUIAndEPUIChartDaily end");
