...
/**
 * Servlet implementation class getMonthList 月份下拉選單
 */
@WebServlet("/getMonthList")
public class getMonthList extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getFormatterLogger(getMonthList.class.getName());
...
//		logger.debug("getMonthList rsp: " + rspJson);
	...
	private ListMsgBean convertToJson() throws Exception {
		...
		try {
			...
			for(int i=1; i<=12; i++) {
				...
				bean.setLable(StringUtils.leftPad(String.valueOf(i), 2, "0"));
