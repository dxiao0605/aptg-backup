...
/**
 * Servlet implementation class addPeriodSetting 新增命令任務(時間週期設定)
 */
@WebServlet("/addPeriodSetting")
public class addPeriodSetting extends HttpServlet {
	...
	private static final Logger logger = LogManager.getFormatterLogger(addPeriodSetting.class.getName()); 

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public addPeriodSetting() {
		super();
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logger.debug("addPeriodSetting start");
...
//			String timezone = ObjectUtils.toString(request.getHeader("timezone"));
		...
		logger.debug("addPeriodSetting end");
	...
	private CommandTaskVO parseJson(String json) throws Exception {
		...
		try {
			...
			int uploadCycle = msg.optInt("UploadCycle");
			int irCycle = msg.optInt("IRCycle");
			int communicationCycle = msg.optInt("CommunicationCycle");
