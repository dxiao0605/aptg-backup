...
import { checkObject, getSelectObj } from '../../components/FilterDrawer/utils';  //整理checkbox狀態,連動清單 
import { ajaxDelFilter, ajaxGetFilter, ajaxGetBatteryHistoryFilter } from '../../components/FilterDrawer/utils'; //getApi}
...
class Filter extends Component {
    ...
    getBatteryFilter = (defaultCompany, defaultCountry, defaultArea, defaultGroupId,
        ...
        ajaxGetBatteryHistoryFilter({query}).then((response) => {
