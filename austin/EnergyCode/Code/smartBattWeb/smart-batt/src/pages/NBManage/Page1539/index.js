...
import { ajaxSaveFilter } from '../../../components/FilterDrawer/utils';//儲存篩選內容
import { ajaxGetNBHistory } from './getApi';
import { returnPostData } from './utils';   //回傳篩選條件
...
class Page1539 extends Component {
    ...
    onExportExcel = () => {
        ...
        ajaxGetNBHistory({query,postData}).then((response) => {
