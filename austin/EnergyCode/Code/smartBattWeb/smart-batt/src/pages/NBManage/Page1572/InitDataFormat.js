...
export const FilterNames = {//篩選欄位命名
    ...
    isFilterGroupIdData: "isFilterGroupIdData",//站台編號/名稱 * 1125
    isFilterNBIDData: "isFilterNBIDData",//通訊序號 * 1057
    isFilterPreviousNBIDData: "isFilterPreviousNBIDData",//(接續)通訊序號 * 1573
    isFilterStartTimeData: 'isFilterStartTimeData',//接續開始時間 * 1574
}
...
export const FilterNames_API = {//篩選欄位命名(api)
    ...
    isFilterNBIDVirtue: "NBIDValue",//通訊序號
}
