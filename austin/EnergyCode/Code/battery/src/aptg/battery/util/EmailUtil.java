...
//			ResourceBundle commonRb = ResourceBundle.getBundle("email", Locale.getDefault(), loader);
//			ResourceBundle commonRb = ResourceBundle.getBundle("email");
//			this.mode = commonRb.getString("mail.mode");
//			this.host = commonRb.getString("mail.smtp.host");
//			this.from = commonRb.getString(mode+".mail.sender");
