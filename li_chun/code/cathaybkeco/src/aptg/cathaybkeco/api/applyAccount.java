...
/**
 * Servlet implementation class applyAccount 帳號申請
 */
@WebServlet("/applyAccount")
public class applyAccount extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getFormatterLogger(applyAccount.class.getName()); 
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logger.debug("applyAccount start");
			...
			if (StringUtils.isNotBlank(req)) {
				...
				if(adminSetupVO.isError()) {
					...
					if (userInfoList != null && userInfoList.size() != 0) {
						...
						ToolUtil.addLogRecord(adminSetupVO.getUserName(), "20", "帳號申請");
