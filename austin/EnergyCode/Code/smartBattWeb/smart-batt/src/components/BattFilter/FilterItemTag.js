                ...
                <div className="d-inline-block">
                    {
                        ...
                        isFilterCompanyData.isButtonList.map((item, idx) => {
                            return <button key={item.Value} className="btn-sm-b1 btn-outline-primary mr-2">
                                {
                                    functionId === '1400_2' ? <></> : <i className="fas fa-window-close mr-1" onClick={() => this.props.submitFilterItemTag(FilterNames.isFilterCompanyData, item, idx)} />
                                }
                                {item.Label}
                            </button>
                        })
                    }
                    {
                        ...
                        isFilterCountryData.isButtonList.map((item, idx) => {
                            return <button key={item.Value} className="btn-sm-b1 btn-outline-primary mr-2">
                                {
                                    functionId === '1400_2' ? <></> : <i className="fas fa-window-close mr-1" onClick={() => this.props.submitFilterItemTag(FilterNames.isFilterCountryData, item, idx)} />
                                }
                                {item.Label}
                            </button>
                        })
                    }
                    {
                        ...
                        isFilterAreaData.isButtonList.map((item, idx) => {
                            return <button key={item.Value} className="btn-sm-b1 btn-outline-primary mr-2">
                                {
                                    functionId === '1400_2' ? <></> : <i className="fas fa-window-close mr-1" onClick={() => this.props.submitFilterItemTag(FilterNames.isFilterAreaData, item, idx)} />
                                }
                                {item.Label}
                            </button>
                        })
                    }
                    {
                        ...
                        isFilterGroupIdData.isButtonList.map((item, idx) => {
                            return <button key={item.Value} className="btn-sm-b1 btn-outline-primary mr-2">
                                {
                                    functionId === '1400_2' ? <></> : <i className="fas fa-window-close mr-1" onClick={() => this.props.submitFilterItemTag(FilterNames.isFilterGroupIdData, item, idx)} />
                                }
                                {item.Label}
                            </button>
                        })
                    ...
                    }
                    {
                        ...
                        isFilterBatteryStatusData.isButtonList.map((item, idx) => {
                            return <button key={item.Value} className="btn-sm-b1 btn-outline-primary mr-2">
                                {
                                    functionId === '1400_2' ? <></> : <i className="fas fa-window-close mr-1" onClick={() => this.props.submitFilterItemTag(FilterNames.isFilterBatteryStatusData, item, idx)} />
                                }
