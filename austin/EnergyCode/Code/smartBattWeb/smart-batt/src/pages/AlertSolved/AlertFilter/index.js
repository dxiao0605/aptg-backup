...
import { 
    checkObject, getSelectObj, 
    ajaxGetFilter, ajaxDelFilter, ajaxGetAlertFilter 
} from '../../../components/FilterDrawer/utils';//整理checkbox狀態
...
class AlertFilter extends Component {
    ...
    getBatteryFilter = (defaultEventTypeCode, defaultCompany, defaultCountry, defaultArea, defaultGroupId,) => {
        ...
        ajaxGetAlertFilter({query}).then((response) => {
