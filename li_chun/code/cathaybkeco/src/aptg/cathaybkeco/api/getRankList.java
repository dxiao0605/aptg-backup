...
/**
 * Servlet implementation class getRankList 權限下拉選單
 */
@WebServlet("/getRankList")
public class getRankList extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getFormatterLogger(getRankList.class.getName());
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logger.debug("getRankList rsp: " + rspJson);
