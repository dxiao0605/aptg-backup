...
/**
 * Servlet implementation class addEntryBill 新增電費單
 */
@WebServlet("/addEntryBill")
public class addEntryBill extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LogManager.getFormatterLogger(addEntryBill.class.getName());
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		logger.debug("addEntryBill start");
				...
				if (!ToolUtil.checkToken(token)) {
					...
					if (entryBillVO.isError()) {
						...
						if(checkBillMon(entryBillVO)) {
							...
							entryBillDAO.addEntryBill(entryBillVO);
							ToolUtil.addLogRecord(entryBillVO.getUserName(), "13", "新增"+entryBillVO.getPowerAccount()+"電費單"+entryBillVO.getBillMon());
