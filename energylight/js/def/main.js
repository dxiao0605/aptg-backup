...
function addHtmlCard(head, elight, eaircon, cardid) {
	...
	html += "<div class='text-success h4 mt-1 text-lightbulb'> <i class='fas fa-lightbulb fa-fw mr-3' ></i>"	+ elight + " W</div>"
	html += "<div class='text-success h4 mt-1 text-itoch' > <i class='fas fa-chalkboard fa-fw mr-3'></i>"+ eaircon + " W</div>"
	html += "</div>"
