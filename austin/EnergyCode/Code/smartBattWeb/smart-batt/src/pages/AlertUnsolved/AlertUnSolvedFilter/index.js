...
import { checkObject, getSelectObj, } from '../../../components/FilterDrawer/utils'; //整理checkboxk狀態、連動清單
import { ajaxGetFilter, ajaxDelFilter, ajaxGetUnSolvedAlertFilter } from '../../../components/FilterDrawer/utils';//getApi
...
class AlertUnSolvedFilter extends Component {
    ...
    getBatteryFilter = (defaultEventTypeCode, defaultCompany, defaultCountry, defaultArea, defaultGroupId,
        ...
        ajaxGetUnSolvedAlertFilter({query}).then((response) => {
