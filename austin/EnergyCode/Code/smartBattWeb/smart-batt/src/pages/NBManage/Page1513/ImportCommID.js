...
const ImportCommID = ({habdleUpdateDefNBList,handleAlertMsgOpen}) => {
    ...
    const handleFileUpdate = () => {
        ...
        xhr.open('POST', `importNBID`);   // 設置xhr得請求方式和url。
    ...
    return (
        <Fragment>
            ...
            <div className="col-12 my-4 pl-0 pr-0">
                {/* 通訊序號匯入 */}
                <div className="font-weight-bold col-12" style={{ backgroundColor: '#525b6c', color: '#fff', lineHeight: '3', borderRadius:'4px' }}>{t('1514')}</div>
                ...
                <div className="px-4 py-4 bg-white">
                    <div className="form-inline align-items-center">
                        ...
                        <div className="d-inline-flex col-12 col-xl-1 btn-primary exportBtnShadow mr-xl-3 my-2 cursor-pointer" style={{ background: '#03c3ff', borderColor: '#03c3ff' }}>
