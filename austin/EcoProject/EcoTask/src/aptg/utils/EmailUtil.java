...
public class EmailUtil {
	...
	private static final String Sysconfig_MailPort				= "MailPort";
	
	private static final String Sysconfig_MailToList			= "MailToList";
...
//	private String appLocation = "";
	...
	public EmailUtil(){	
		try {
			this.host = SysConfigManager.getInstance().getSysconfig(Sysconfig_MailHost);
			this.from = SysConfigManager.getInstance().getSysconfig(Sysconfig_MailSender);
			this.user = SysConfigManager.getInstance().getSysconfig(Sysconfig_MailSender);
			this.pwd = SysConfigManager.getInstance().getSysconfig(Sysconfig_MailPassword);
			this.port = SysConfigManager.getInstance().getSysconfig(Sysconfig_MailPort);
			
			String mailToList = SysConfigManager.getInstance().getSysconfig(Sysconfig_MailToList);
			String[] mailTo = mailToList.split(";");
			this.toList = Arrays.asList(mailTo);
