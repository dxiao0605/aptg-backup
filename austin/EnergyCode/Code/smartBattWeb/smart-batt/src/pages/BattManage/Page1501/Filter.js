...
import { ajaxDelFilter, ajaxGetFilter, ajaxGetBattManageFilter } from '../../../components/FilterDrawer/utils'; // getApi
...
class Filter extends Component {
                ...
                <ul className={`filter overflowY mb-0 ${navigator.userAgent.indexOf('Windows') > 0 ? 'Windows' : 'Mac'}`}>
                    ...
                    <li>{/* 電池組ID */}
                        <FilterItemHeader
                            ...
                            onUpdateChainSelectList={() => this.onUpdateChainSelectList('BatteryValue', getSelectObj(isFilterBatteryGroupIdList))}
    ...
    getBattManageFilter = (defaultCompany, defaultBatteryGroupId) => {
        ...
        ajaxGetBattManageFilter({query}).then((response) => {
